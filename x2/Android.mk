...
include $(CLEAR_VARS)
LOCAL_MODULE := CustDolbySettings
LOCAL_MODULE_OWNER := leeco
LOCAL_SRC_FILES := proprietary/priv-app/CustDolbySettings/CustDolbySettings.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := leeco
LOCAL_SRC_FILES := proprietary/priv-app/DolbyAtmos/DolbyAtmos.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
